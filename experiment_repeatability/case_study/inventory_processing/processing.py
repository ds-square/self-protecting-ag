    ...
    def perform(params):
        ...
        for aggregation_mode in range(4):
            ...
            with open(config.ANALYSIS_AGGREGATION_FILE, 'a', newline='') as fd:
                ...
                writer.writerow([inventory_name,scan_id,step_id,filter_id,aggregation_mode,"NETSPA",tot_time])
                writer.writerow([inventory_name,scan_id,step_id,filter_id,aggregation_mode,"TVA",tot_time])
                writer.writerow([inventory_name,scan_id,step_id,filter_id,aggregation_mode,"MULTI",tot_time])
